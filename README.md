...
```sh
git clone git@github.com:nikbrunner/lazyvin ~/.config/lazyvin
NVIM_APPNAME=lazyvin nvim --headless +Lazy! sync +qa
```

Open Neovim with this config:

```sh
NVIM_APPNAME=lazyvin nvim
```

I recommend setting an alias in your shell:

```shell
alias lazyvin="NVIM_APPNAME=lazyvin nvim"
```

## Plugins

This Plugin List was generated by [Dotfyle](https://dotfyle.com).
