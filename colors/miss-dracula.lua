...
-- Source: [dotfiles/.config/nvim/colors/miss-dracula.lua at main · MariaSolOs/dotfiles](https://github.com/MariaSolOs/dotfiles/blob/main/.config/nvim/colors/miss-dracula.lua)
